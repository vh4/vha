...
export const useGetSales = (): Menu[] => {
  ...
  return [
    ...
    },
    {
        ...
        url: "https://www.fiverr.com/fathoniwasesoj/",
        image:'/web.jpg',
        offer:[menu("offer1_sale_2"), menu("offer2_sale_2"), menu("offer3_sale_2"), menu("offer4_sale_2"), menu("offer5_sale_2")]
      },
      {
        ...
        offer:[menu("offer1_sale_3"), menu("offer2_sale_3"), menu("offer3_sale_3"), menu("offer4_sale_3"), menu("offer5_sale_3")]
      },
  ];
};