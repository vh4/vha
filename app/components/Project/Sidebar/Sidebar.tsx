...
export const Sidebars: React.FC<SidebarProps> = ({
  pickData,
  toggleSidebar,
  setToggleSidebar,
}) => {
    ...
    <div ref={containerRef} className="fixed inset-0 z-50 flex justify-end">
      ...
      >
        ...
        <Box className="p-4 lg:p-8">
          ...
          <Box className="mt-2">
            <Text as="div" className="text-xs text-justify">
          ...
          <Box className="mt-2">
            <Text as="div" className="text-xs text-justify">
              {pickData?.role} - {pickData?.company}
            </Text>
          </Box>
          <Box className="mt-2">
            <Text as="div" className="text-xs text-justify">
              {pickData?.year_start} - {pickData?.year_end}
            </Text>
          </Box>
        </Box>
